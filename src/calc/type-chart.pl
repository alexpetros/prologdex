...
effectiveness_modifier(strong, 0.5).
effectiveness_modifier(normal, 1.0).
effectiveness_modifier(weak, 2.0).
effectiveness_modifier(very_weak, 4.0).

mon_type_chart(Mon, T, M) :-
  effectiveness(M),
  M \= normal,
